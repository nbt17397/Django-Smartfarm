...
class BuildingDetail(ItemBase):
    ...
    source_pump_group_id = models.SmallIntegerField(null=True, blank=True, default=0) 
    clarifier_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    nanobubble_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    oxygen_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    pond1_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    pond2_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    pond3_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    overview_group_id = models.SmallIntegerField(null=True, blank=True, default=0)  
    pond_param_group_id = models.SmallIntegerField(null=True, blank=True, default=0)
    setting_group_id = models.SmallIntegerField(null=True, blank=True, default=0)   
